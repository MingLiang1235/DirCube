...
class MyFrame(wx.Frame):
	...
	def __init__(self):
		...
		wx.Frame.__init__(self,None,-1,u"DirCubie",size=(self.width,self.height))
	...
	def doMakeMenu(self):
		...
		doBind( helpMenu.Append(-1,u"关于DirCubie(&A)\tCtrl+A","About Dir Cubie"),
				self.OnAbout )
	...
	def OnAbout(self,evt):
		...
		info.SetCopyright("(c) 2019 Unicoder <unicoder@sohu.com>")
		wx.AboutBox(info)
	def OnHelp(self,evt):
		webbrowser.open_new_tab('https://unicoder.myds.me/DirCubie/help.html')
	def OnPerchase(self,evt):
		webbrowser.open_new_tab('https://unicoder.myds.me/Donate/')
